...
Implement a function that draws an unfilled rectangle on the canvas. Promp the user for the x- and y-cooredinates of the topleft corner of the rectangle. Your rectangle must meet each of the following positional requirements.
